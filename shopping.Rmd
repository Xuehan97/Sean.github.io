...
From this plot, we can see the variation of order hour of different Beverages during a week.
...
From this plot, we can see the number of items ordered in top aisles. 
...
From this plot, we can see the order hour of items in different departments.